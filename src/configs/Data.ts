...
import { Tasks } from "res/type/Tasks";
...
export const ABOUT = {
  ...
  images: [images.img_map, images.img_map],
  ...
  imageSchool: images.img_boston_university,
...
export const REVIEWS = {
  ...
  review: [
    {
      avatar: images.avatar_myra_douglas,
      name: "Myra Douglas",
      rate: "5.0",
      date: "Jan 05, 2020",
      description:
    ...
    {
      avatar: images.avatar_nancy_beck,
      name: "Nancy Beck",
      rate: 4.9,
      date: "Jan 02, 2020",
      description:
...
export const DATA_SPECIALITY = [
  ...
  {
    id: 2,
    icon: images.ic_vaccination,
    name: "Anesthesiology",
    doctorAvailable: 11,
  },
  {
    id: 3,
    icon: images.ic_cardiology,
    name: "Cardiology",
    doctorAvailable: 10,
  },
  {
    id: 4,
    icon: images.ic_deficiency,
    name: "Deficiency",
    doctorAvailable: 12,
  },
  {
    id: 5,
    icon: images.ic_dermatology,
    name: "Dermatology",
    doctorAvailable: 4,
  },
  {
    id: 6,
    icon: images.ic_disability,
    name: "Disability",
    doctorAvailable: 3,
  },
  {
    id: 7,
    icon: images.ic_emergency_white,
    name: "Emergency",
    doctorAvailable: 2,
  },
  {
    id: 8,
    icon: images.ic_record_white,
    name: "Endocrinology",
    doctorAvailable: 15,
  },
];
...
export const MY_QUESTION_DETAILS = [
  {
    ...
    image: images.img_7,
    answer: `Always use your own pen at the doctor's office and not the pen 100's of infected patients touched.`,
    doctorsAgreed: [images.avatar_1, , images.avatar_2, images.avatar_3],
    numberAgreed: 125,
    numberThanks: 125,
    thanked: true,
  },
  {
    ...
    doctorsAgreed: [images.avatar_1, , images.avatar_2],
    numberAgreed: 4,
    numberThanks: 24,
    thanked: false,
  },
...
export const PROFILE = [
  ...
  {
    id: 1,
    avatar: images.avatar_12,
    name: "Nora Shelton",
    progress: 100,
  },
  {
    id: 2,
    avatar: images.avatar_13,
    name: "Nora Shelton",
    progress: 100,
  },
];
...
export const FEATURE_CATEGORY = [
  {
    id: 0,
    icon: images.ic_additional_information,
    name: "Basic Information",
    route: Routes.MyRecordBasicInformation,
  },
  {
    id: 1,
    icon: images.ic_health_metric,
    name: "Health Metrics",
    route: Routes.MyRecordHealthMetric,
  },
  {
    id: 2,
    icon: images.ic_condition,
...
export const FOLLOWING_TOPIC_HEADER = [
  ...
  },
  {
    ...
    img: images.img_rocket,
    topicName: "",
  },
];
export const TOPIC_DETAILS_BUTTON = [
  { id: 0, icon: images.ic_additional_information, name: "Overview" },
  {
    id: 1,
    icon: images.ic_condition,
    name: "Conditions & Symptoms",
  ...
  { id: 2, icon: images.ic_medication, name: "Medications" },
  { id: 3, icon: images.ic_procedure, name: "Procedures" },
  { id: 4, icon: images.ic_health_guide, name: "Health Guide" },
];
...
export const TOP_SPECIALITIES = [
  { id: 0, name: "Cardiology", icon: images.ic_cardiology },
  { id: 1, name: "Anesthesiology", icon: images.ic_vaccination },
];
export const SEARCH_SPECIAL_BUTTON = [
  {
    id: 0,
    name: "Doctors",
    icon: images.ic_doctor,
...
export const HEALTH_TIPS_DATA = [
  {
    id: 0,
    tipName: "Flu & Cold",
    doctor: { name: "Jonathan Peters", avatar: images.doctor_1 },
    img: images.img_industry,
    numberOfThanks: 123,
    numberOfShares: 12,
    detail:
  ...
  },
  {
    ...
    doctor: { name: "Maurice Watson", avatar: images.doctor_2 },
    img: images.img_light,
    numberOfThanks: 123,
    numberOfShares: 12,
    detail:
  ...
  },
  {
    id: 2,
    tipName: "Flu",
    doctor: { name: "Sarah Corner", avatar: images.doctor_3 },
    img: images.img_chimney,
    numberOfThanks: 123,
    numberOfShares: 12,
    detail:
...
export const ALL_HOSPITAL = [
  {
    id: 0,
    distance: 2,
    avatar: images.img_mount_sinai,
    img: images.img_hospital,
...
export const MEDICATION_DETAIL_BUTTON = [
  ...
  {
    id: 1,
    icon: images.ic_account_active,
    name: "Uses for",
  },
  { id: 2, icon: images.ic_side_effect, name: "Side Effect" },
  { id: 3, icon: images.ic_health_guide, name: "Health Guide" },
];
...
export const FILE_EXAMPLES = [
  {
    id: 0,
    image: images.img_topic_chickenpox,
  ...
  {
    id: 1,
    image: images.img_topic_cardiology,
...
export const CHAT_EXAMPLE = [
  ...
  { id: 6, attachImg: images.img_health_guide, time: "", date: "", isYour: true },
  { id: 7, attachImg: images.img_topic_chickenpox, time: "", date: "", isYour: false },
];
